...
import gov.dhs.cisa.ctm.flare.client.api.service.dto.ServerCredentialDTO;
...
import gov.dhs.cisa.ctm.flare.client.api.web.rest.ServerResource;
import gov.dhs.cisa.ctm.flare.client.error.ErrorConstants;
import gov.dhs.cisa.ctm.flare.client.error.ServerNotFoundException;
...
public class ServerResourceTest {
    ...
    @Test
    public void testCreateTaxii21ServerAuth() throws Exception {
        ServerDTO serverDTO = new ServerDTO();
        serverDTO.setLabel(TestData.taxii21Server.getLabel());
        serverDTO.setUrl(TestData.taxii21Server.getUrl().toString());
        serverDTO.setRequiresBasicAuth(false);
