...
public class Taxii21Server extends TaxiiServer {
    ...
    public URI getStatusUrl(String apiRootEndpoint, String statusId, boolean traceOption) {
        return this.getApiRootUrl(apiRootEndpoint).resolve(String.join("/", Constants.TAXII2_STATUS_ENDPOINT, statusId, "/?trace=" + String.valueOf(traceOption))).normalize();
    }
