...
/**
 * An object for representing the current status of TAXII 2.1 publish/upload
 * requests
 */
...
public class Status extends AbstractAuditingEntity implements Serializable {
	...
	public void setSuccesses(HashSet<StatusDetails> successes) {
	...
	public void setFailures(HashSet<StatusDetails> failures) {
	...
	public void setPendings(HashSet<StatusDetails> pendings) {
