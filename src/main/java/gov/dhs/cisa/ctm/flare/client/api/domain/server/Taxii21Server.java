...
public class Taxii21Server extends TaxiiServer {
	...
	public URI getStatusUrl(String apiRootEndpoint, String statusId) {
		return this.getApiRootUrl(apiRootEndpoint)
				.resolve(String.join("/", Constants.TAXII2_STATUS_ENDPOINT, statusId, "/")).normalize();
	}
	...
	private URI getCollectionUrl(String apiRootEndpoint, String collectionId) {
		return this.getApiRootUrl(apiRootEndpoint)
				.resolve(String.join("/", Constants.TAXII2_COLLECTIONS_ENDPOINT, collectionId, "/")).normalize();
	}

	/** /{apiRoot}/collections/{collectionId}/objects/ */
	public URI getCollectionObjectsUrl(String apiRootEndpoint, String collectionId) {
		return this.getCollectionUrl(apiRootEndpoint, collectionId).resolve(Constants.TAXII2_OBJECTS_ENDPOINT)
				.normalize();
	}
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(getId(), that.getId()) && Objects.equals(getLabel(), that.getLabel());
	}
