...
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "stixVersion", visible = true)
@JsonSubTypes({ @JsonSubTypes.Type(value = Stix1ContentWrapper.class, name = "STIX1"),
...
public abstract class AbstractContentWrapper {
	...
	/**
	 * The content ID taken from either the STIX 1.X 'id' attribute, or the STIX 2.X
	 * 'id' property
	 */
	@Field("content_id")
	...
	/**
	 * The content timestamp taken from either the STIX 1.X 'timestamp' attribute,
	 * or the STIX 2.X 'modified' property
	 */
	...
	/**
	 * A generic validate method that will result in ValidationResult to be applied
	 * to the ContentWrapper
	 * 
